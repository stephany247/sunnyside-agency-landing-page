...
const ServiceCard = ({ bgClass, title, description, textColor }: ServiceCardProps) => {
  return (
    <div className={`${bgClass} bg-cover bg-top bg-no-repeat w-full min-h-screen h-[130vh] md:h-fit relative text-center ${textColor} font-bold flex flex-col items-center justify-end`}>
